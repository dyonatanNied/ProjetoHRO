...
class FormulariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulario" do
    assert_difference("Formulario.count") do
      post formularios_url, params: { formulario: { amostra: @formulario.amostra, aplicabilidade: @formulario.aplicabilidade, calibracao: @formulario.calibracao, controleQualidade: @formulario.controleQualidade, descricao: @formulario.descricao, equipamento: @formulario.equipamento, material: @formulario.material, objetivo: @formulario.objetivo, titulo: @formulario.titulo } }
    end
  ...
  test "should update formulario" do
    patch formulario_url(@formulario), params: { formulario: { amostra: @formulario.amostra, aplicabilidade: @formulario.aplicabilidade, calibracao: @formulario.calibracao, controleQualidade: @formulario.controleQualidade, descricao: @formulario.descricao, equipamento: @formulario.equipamento, material: @formulario.material, objetivo: @formulario.objetivo, titulo: @formulario.titulo } }
